...
## Installation
### Check the general installation [here](https://github.com/CMU-Perceptual-Computing-Lab/openpose/blob/master/doc/installation.md). Make sure to download and install the prerequisites for your particular operating system following [doc/openpose/prerequisites.md](doc/openpose/prerequisites.md).
### **Important Tips**
...
```
## Output
### Output (format, keypoint index ordering, etc.) in [doc/output.md](https://github.com/CMU-Perceptual-Computing-Lab/openpose/blob/master/doc/output.md).
...
default:
run these commands in your /Alphapose directory
command: python3 video_demo.py --video {input_dir} --outdir {output_dir} --save_video --detbatch 9 --sp
max memory usage: 8200/11178
processing time:
